...
const ITEMS = [
  ...
  { file: 'c9-s1', prompt:
    'A real 8-month-old Taiwanese baby boy lying limp and unconscious on a colorful foam play mat inside a home playpen with fabric fence. Eyes closed, pale skin, mouth slightly open as if snoring. A mildly swollen reddened area on his forehead, a small faint mark behind one ear, and two small faint older marks on his bare chest and upper arm. Home living room background, toys nearby.' + C },
  // ② OPA + BVM assisted ventilation
  { file: 'c9-s2', prompt:
    'A real 8-month-old Taiwanese baby boy wearing only a diaper, lying flat on his back on a play mat receiving assisted ventilation with an infant bag-valve mask. The clear triangular mask is sealed OVER THE LOWER HALF OF THE FACE, covering ONLY the nose and mouth — NOT on the forehead. One gloved paramedic hand holds the mask in a C-E grip lifting the jaw; the self-inflating bag extends upward away from the face. Eyes closed, limp, pale skin. A mildly swollen reddened area on the forehead, a small faint mark behind one ear, and two small faint older marks on the bare chest and upper arm. A rolled towel under the shoulders. Home interior background.' + C },
