...
const ITEMS = [
  ...
  { file: 'c9-s1', prompt:
    'A real 8-month-old Taiwanese baby boy lying limp and unconscious on a colorful foam play mat inside a home playpen with fabric fence, photographed from above so the TOP of his head is clearly visible. Eyes closed, pale skin, mouth slightly open as if snoring, sparse baby hair. On the TOP of the head — at the midline just behind the front hairline, where the anterior fontanelle is — the scalp shows a soft, smooth, broad and only SLIGHTLY raised fullness (a mildly bulging anterior fontanelle), gently domed and subtle, same skin color as the scalp. It is on the top of the skull, NOT on the forehead, and it is subtle, NOT a big dramatic dome. Also a small faint reddened area on the forehead and one small faint bruise on the upper arm. Home living room background, toys nearby.' + C },
  // ② OPA + BVM assisted ventilation
  { file: 'c9-s2', prompt:
    'A real 8-month-old Taiwanese baby boy lying flat on his back on a play mat receiving assisted ventilation with an infant bag-valve mask. The clear triangular mask is sealed OVER THE LOWER HALF OF THE FACE, covering ONLY the nose and mouth (its narrow tip on the bridge of the nose, its wide base on the chin) — it is NOT on the forehead and NOT on the top of the head. One gloved paramedic hand holds the mask in a C-E grip with fingers lifting the jaw; the self-inflating bag extends upward away from the face. Baby\'s eyes closed, limp, pale skin, sparse baby hair. On the TOP of the head at the midline just behind the front hairline (the anterior fontanelle), the scalp shows a soft smooth broad only SLIGHTLY raised fullness — a mildly bulging fontanelle, subtle, skin-colored, NOT a big dome, NOT on the forehead. A rolled towel under the shoulders. Home interior background.' + C },
  // ③ Transport: neutral c-spine, ventilation continuing, warming
  { file: 'c9-s3', prompt:
    'A real 8-month-old Taiwanese baby boy secured on an ambulance stretcher with soft head blocks keeping the head and neck in a neutral straight position, wrapped warmly in a blanket, viewed from slightly above so the top of the head is visible. Eyes closed, pale but stable skin color, sparse baby hair. On the TOP of the head at the midline just behind the front hairline (the anterior fontanelle), the scalp shows a soft smooth broad only SLIGHTLY raised fullness — a mildly bulging fontanelle, subtle, skin-colored, NOT a big dramatic dome, NOT on the forehead. A gloved hand continues gentle bag-valve-mask ventilation with the mask over his nose and mouth. ECG electrode stickers on the chest, monitor in the background. Ambulance interior.' + C },
];
